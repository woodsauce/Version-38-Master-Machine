...
## V38.1 price-neutral lock rule

Money, odds, payout, EV, and expensive-price warnings are display-only. They do not add confirmations, remove confirmations, change the master score, or block an accuracy-valid official lock. The master machine focuses on picking the correct side first; money handling can be reviewed later.
